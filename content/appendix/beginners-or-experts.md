...
description: "Who this course is for and what to expect—level, style, and pacing."
...
**Beginners (to RL or programming):** The course is designed to be accessible. Start with the [Learning path](../learning-path/) Phase 0 if you have no programming. Use [Math for RL](../math-for-rl/) and [Prerequisites](../prerequisites/) before or alongside Volume 1. The [Preliminary assessment](../preliminary/) helps you check readiness. Exercises have hints and worked solutions so you can learn step by step. You do **not** need a PhD or prior ML course—but you do need to invest time in prerequisites if your background is light.

**Experts (ML/RL experience):** You can move quickly through Volumes 1–2 (review bandits, MDPs, DP, MC, TD) and spend more time on Volumes 3–10 (approximation, deep RL, model-based, offline, MARL, etc.). Use the [Course outline](../../course-outline/) to jump to topics you need. The 100 chapters and exercises still serve as a structured reference and implementation check.
...
- **Slow (building from zero):** Start with [Learning path](../learning-path/) Phases 0–2 (programming, math, prerequisites), then 3–6 months for Volumes 1–3, and more for the rest.

Consistency (e.g. 30–60 min per day) matters more than total hours per week. See [How to Succeed (Long Version)](how-to-succeed-long/) for more detail.
