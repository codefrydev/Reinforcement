...
{{< chart type="line" palette="return" title="Mean return vs env steps (Walker)" labels="0, 100k, 200k, 300k, 400k" data="0, 500, 1500, 2500, 3500" xLabel="Env step" yLabel="Mean return" >}}
